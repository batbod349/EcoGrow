 ...
 */
final class Version20241108080733 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP image_data');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD image_data LONGBLOB DEFAULT NULL');
    }
}
